...
const FormBroadcastEditPlaylist: React.FC<Props> = ({ broadcast }) => {
                        ...
                        <div className='form-top-left'>
                            <div className='form-column' style={{padding: '5px', marginLeft: '10px'}}>
                                ...
                                <div className='form-column' style={{margin: '15px 0'}}>
                                    ...
                                    <Input className='form' style={{width: '240px'}} value={broadcast?.name}></Input>
                                </div>
                                <div className='form-column' style={{margin: '15px 0'}}>
...
export default FormBroadcastEditPlaylist;
