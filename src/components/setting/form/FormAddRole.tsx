            ...
            <div className='content-upper' style={{border: 'none', marginTop: '50px'}}>
                <div className='content-column'>
                    ...
                    <div className='form-horizon'>
                        ...
                        <Input.TextArea className='form' style={{width: '325px', height: '120px'}}></Input.TextArea>
                    </div>
                </div>
                ...
                <div className='form-column' style={{marginLeft: '300px'}}>
                    ...
                    <div className='form-column'>
                        <div style={{backgroundColor: '#2F2F41', width: '1063px', height: '558px', border: '1px solid transparent', borderRadius: '8px'}}>
