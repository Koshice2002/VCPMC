        ...
        {isDesktopOrLaptop ? (
            <div className="menu">
                ...
                <div className="items">
                    ...
                    >
                        <div className={page === 'Contract' ? 'item item-active' : 'item'} style={{marginLeft: '25px', borderLeft: page === 'Contract Manage' ? '1px solid #ff7506' : 'none'}}>
                            <i className='icon-item'>
                                <FileTextOutlined />
                            </i>
                            <span>Quản lý</span>
                        </div>
                        <i className= {page === 'Contract' ? 'icon-more item-active' : 'icon-more'}>
