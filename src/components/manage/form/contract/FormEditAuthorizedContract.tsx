...
const FormEditAuthorizedContract: React.FC<Props> = ({ contract }) => {
        ...
        {isDesktopOrLaptop ? (
            <div className='add-contract-content'>
                <div className='content-upper'>
                    <div className='content-column'>
                        <div className='form-horizon'>
                            <p style={{ marginRight: '10px', width: '200px' }}>Số hợp đồng </p>
                            <Input className='form' style={{width: '325px'}} value={contract?.number}></Input>
                        </div>

                        <div className='form-horizon'>
                            <p style={{ marginRight: '10px', width: '200px' }}>Tên hợp đồng </p>
                            <Input className='form' style={{width: '325px'}} value={contract?.name}></Input>
                        </div>

                        <div className='form-horizon'>
                            <p style={{ marginRight: '10px', width: '200px' }}>Ngày hiệu lực </p>
                            <DatePicker
                                format="DD/MM/YYYY"
                        ...
                        <div className='form-horizon'>
                            <p style={{ marginRight: '10px', width: '200px' }}>Ngày hết hạn </p>
                            <DatePicker
                                format="DD/MM/YYYY"
                                placeholder='dd/mm/yy'
                                className={`form`} style={{width: '325px'}}
                        ...
                        {value === 1 ? (
                            <>
                                ...
                                <div className='form-horizon'>
                                    ...
                                    <Input className='form' style={{width: '325px'}} value={contract?.person}></Input>
                                </div>
                                <div className='form-horizon'>
                ...
                <div className='title' style={{margin: '40px 0'}}>
                    ...
                    <Link to={`/info-contract/${contract?.id}`}>
...
export default FormEditAuthorizedContract;
