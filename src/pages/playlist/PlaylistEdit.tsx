...
import FormEditPlaylist from '../../components/playlist/form/FormEditPlaylist';
  ...
  return (
    <MainLayout>
        <div style={{ marginLeft: '-120px'}}>
            ...
            <FormEditPlaylist playlist={playlist}></FormEditPlaylist>

            <AddSongToPlaylistBtn playlistId={playlist?.id}></AddSongToPlaylistBtn>
        </div>
    </MainLayout>
  )
};
